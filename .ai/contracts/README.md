...
| [fileformat_v6.md](fileformat_v6.md) | **Draft** (annotations + base vocabulary **LOCKED**; feedback extension **DRAFTED**) | Unified recording+feedback metadata; v6 clean cut (not implemented) |
